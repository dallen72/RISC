...
add wave -radix hex -position end  sim:/risc_processor/fetch_stage/counter
add wave -position end  sim:/risc_processor/fetch_stage/rst
add wave -position end  sim:/risc_processor/fetch_stage/branch_en
add wave -position end  sim:/risc_processor/fetch_stage/branch_addr
...
add wave -position end  sim:/risc_processor/fetch_stage/instruction_Rx_shift_reg_rd
...
add wave -position end  sim:/risc_processor/fetch_stage/sig_pulse_branch_en
